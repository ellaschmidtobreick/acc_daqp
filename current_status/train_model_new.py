...
from generate_graph_data_new import generate_qp_graphs_train_val 
import config 
...
lr = config.lr
number_of_epochs = 30 #config.number_of_epochs #70 #300 # 500 
...
#while acc != 1:
    ...
    if track_on_wandb == True:
        run.log({"acc_train": acc,"acc_val": val_acc,"loss_train": train_loss, "loss_val": val_loss, "prec": prec, "rec": rec, "f1": f1, "acc_graph": acc_graph, "acc_graph_val": acc_graph_val,"perc_wrong_pred_nodes_per_graph": val_perc_wrongly_pred_nodes_per_graph,"num_wrong_pred_nodes_per_graph":val_mean_wrongly_pred_nodes_per_graph, "threshold": t})
