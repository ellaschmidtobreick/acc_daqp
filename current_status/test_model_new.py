...
from generate_graph_data_new import generate_qp_graphs_test_data_only
...
n = 25 #config.n
m= 100 #config.m
model_path = "saved_models/model_10v_40c.pth" #"saved_models/model_10_25v_25_100c.pth" #"saved_models/model_10v_40c.pth"
...
histogram_time(test_time_before, test_time_after_no_ignored_constraints, save= False)
...
barplot_iterations(test_iterations_before,test_iterations_after_no_ignored_constraints, "iterations",save = False)
