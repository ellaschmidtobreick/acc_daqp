...
#     with open("./data/scaling_data_test.pkl", "wb") as f:
...
# Load data
with open("./data/scaling_data_test.pkl", "rb") as f:
    points_loaded, labels_loaded,iterations_after_loaded = pickle.load(f) # ,iterations_after_loaded

plot_scaling(points_loaded, labels_loaded,"plots/scaling_plot_test")
plot_scaling_iterations(iterations_after_loaded, labels_loaded,"plots/scaling_plot_iterations_test1")
print("Done")
