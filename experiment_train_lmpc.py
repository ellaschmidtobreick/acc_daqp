...
print("test_time_before_avg",test_time_before_avg)
print("test_time_after_avg",test_time_after_avg)
print("test_iterations_before_avg",test_iterations_before_avg)
print("test_iterations_after_avg",test_iterations_after_avg)
print("test_iterations_diff_avg",test_iterations_diff_avg)
...
for i in range(runs):
    ...
    # n = [10]
    # m = [216]
    _,test_time_before, test_time_after, test_iterations_before,test_iterations_after, test_iterations_difference = test_MLP(n,m,nth,seed, data_points,layer_width,number_of_layers,t, False,False,model_name,dataset_type="lmpc",cuda = cuda)
    test_time_before_vector.append(test_time_before)
    test_time_after_vector.append(test_time_after)
    test_iterations_before_vector.append(test_iterations_before)
    test_iterations_after_vector.append(test_iterations_after)
